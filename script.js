...
/* =========================================================
   J-SYRO 3 SECOND CINEMATIC OPENING
   LIVE TYPING
   ========================================================= */
...
(function () {
    ...
    const intro =
        document.getElementById("jsyroIntro");

    const nameEl =
        document.getElementById("jsyroIntroName");

    const taglineEl =
        document.getElementById("jsyroIntroTagline");

    if (!intro || !nameEl || !taglineEl) {
        return;
    }
